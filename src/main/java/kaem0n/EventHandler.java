...
//        pd1.save(new Person("Giovanni", "Neri", "giovanni@neri.it", LocalDate.parse("1973-10-04"), Gender.MALE));
//        pd1.save(new Person("Marco", "Bruni", "marco@bruni.it", LocalDate.parse("1991-04-15"), Gender.MALE));
...
//        ed.save(new AthleticsCompetition("Gara di atletica", LocalDate.now(), "Olympics qualifications", EventType.PRIVATE, 500, stadioOlimpico, athletes, mario));
